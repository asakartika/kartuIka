		...
		<div class="col-sm-6 col-xs-12">
          ...
          <div class="box">
            ...
            <tr data-id2="<?php echo "$a[id_pembayaran]"?>" >
              ...
              <td><?php echo "$a[namaAlumni]"?></td>
              <td>
                <a href="<?php echo base_url(); ?>assets/images/pembayaran/<?php echo "$a[buktiPembayaran]" ?>" data-lightbox="image-2" data-title="My caption">
                  <img src="<?php echo base_url(); ?>assets/images/pembayaran/<?php echo "$a[buktiPembayaran]" ?>" width="100px" height: "100px">
                </a>
              </td>
              <td>
                <div class="btn-group">
                  <button type="button" class="btn btn-info btn-flat info-pembayaran" data-harga = "<?php echo "$a[totalPembayaran]"?>">
                    <i class="fa fa-info"></i>
                  </button>
                  <button type="button" class="btn btn-success btn-flat pembayaran-valid" data-id2="<?php echo "$a[id_pembayaran]"?>" data-nama2 ="<?php echo "$a[namaAlumni]"?>">
                    <i class="fa fa-check"></i>
                  </button>
                  <a href="<?php echo base_url(); ?>adminika/notifikasi/<?php echo "$a[id_alumni]" ?>" type="button" class="btn btn-warning btn-flat">
